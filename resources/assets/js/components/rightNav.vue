...
<template>
    <div>
        ...
        <div class="br-sideright">
            ...
            <div class="tab-content">
                <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto active" id="contacts" role="tabpanel">
                    ...
                    <div class="contact-list pd-x-10">
                        <a href="" class="contact-list-link new">
                            <div class="d-flex">
                                <div class="pos-relative">
                                    <img src="'http://localhost/prime/images/img2.jpg'" class="wd-40 rounded-circle" alt="">
                            ...
                            </div>&lt;!&ndash; d-flex &ndash;&gt;
                        </a>&lt;!&ndash; contact-list-link &ndash;&gt;
                        <a href="" class="contact-list-link">
                            <div class="d-flex">
                                <div class="pos-relative">
                                    <img src="'http://localhost/prime/images/img3.jpg'" class="wd-40 rounded-circle" alt="">
                                    <div class="contact-status-indicator bg-success"></div>
                                </div>
                                <div class="contact-person">
                        ...
                        <a href="" class="contact-list-link new">
                            <div class="d-flex">
                                <div class="pos-relative">
                                    <img src="'http://localhost/prime/images/img4.jpg'" class="wd-40 rounded-circle" alt="">
                                    <div class="contact-status-indicator bg-success"></div>
                                </div>
                                <div class="contact-person">
                        ...
                        <a href="" class="contact-list-link new">
                            <div class="d-flex">
                                <div class="pos-relative">
                                    <img src="'http://localhost/prime/images/img5.jpg'" class="wd-40 rounded-circle" alt="">
                                    <div class="contact-status-indicator bg-success"></div>
                                </div>
                                <div class="contact-person">
                        ...
                        <a href="" class="contact-list-link">
                            <div class="d-flex">
                                <div class="pos-relative">
                                    <img src="'http://localhost/prime/images/img6.jpg'" class="wd-40 rounded-circle" alt="">
                                    <div class="contact-status-indicator bg-success"></div>
                                </div>
                                <div class="contact-person">
                        ...
                        <a href="" class="contact-list-link">
                            <div class="d-flex">
                                <div class="pos-relative">
                                    <img src="'http://localhost/prime/images/img7.jpg'" class="wd-40 rounded-circle" alt="">
                                    <div class="contact-status-indicator bg-success"></div>
                                </div>
                                <div class="contact-person">
                        ...
                        <a href="" class="contact-list-link">
                            <div class="d-flex">
                                <div class="pos-relative">
                                    <img src="'http://localhost/prime/images/img8.jpg'" class="wd-40 rounded-circle" alt="">
                                    <div class="contact-status-indicator bg-success"></div>
                                </div>
                                <div class="contact-person">
                ...
                <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="attachments" role="tabpanel">
                    ...
                    </div>&lt;!&ndash; media-list &ndash;&gt;
                </div>&lt;!&ndash; #history &ndash;&gt;
        ...
        </div>&lt;!&ndash; br-sideright &ndash;&gt;
        &lt;!&ndash; ########## END: RIGHT PANEL ########## -&ndash;&gt;
    </div>
</template>
