...
@section('content')
    ...
    <div class="content-wrapper" style="min-height: 1783.5px;">
        ...
        <section class="content-header">
            <h1>
                Trashed Withdrawals Table
            </h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{!! route('user.dashboard') !!}"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="breadcrumb-item"><a href="{!! route('user.withdrawals_recycle') !!}">User Trashed Withdrawals</a></li>
                <li class="breadcrumb-item active">Trashed Withdrawals Table</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-secondary">
                <div class="box-header with-border">
                    <h3 class="box-title">Trashed Withdrawals</h3>
                        ...
                        @if($withdrawals->count() > 0)
                            <table class="table no-margin no-border table-hover">
                                ...
                                <tr class="bg-dark">
                                    ...
                                    <th class="text-yellow">ETHEREUM WALLET</th>
